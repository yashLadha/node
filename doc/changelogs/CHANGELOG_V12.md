...
* [[`a17cc0f440`](https://github.com/nodejs/node/commit/a17cc0f440)] - **benchmark**: remove problematic tls params (Brian White) [#31816](https://github.com/nodejs/node/pull/31816)
...
* [[`4323215da2`](https://github.com/nodejs/node/commit/4323215da2)] - **build**: allow use of system-installed brotli (André Draszik) [#32046](https://github.com/nodejs/node/pull/32046)
* [[`47213543d8`](https://github.com/nodejs/node/commit/47213543d8)] - **build**: allow passing multiple libs to pkg\_config (André Draszik) [#32046](https://github.com/nodejs/node/pull/32046)
* [[`8dc416b331`](https://github.com/nodejs/node/commit/8dc416b331)] - **build**: enable backtrace when V8 is built for PPC and S390x (Michaël Zasso) [#32113](https://github.com/nodejs/node/pull/32113)
...
* [[`ce67ca84bb`](https://github.com/nodejs/node/commit/ce67ca84bb)] - **cli**: allow --jitless V8 flag in NODE\_OPTIONS (Andrew Neitsch) [#32100](https://github.com/nodejs/node/pull/32100)
...
* [[`9f0f68d9c0`](https://github.com/nodejs/node/commit/9f0f68d9c0)] - **deps**: update archs files for OpenSSL-1.1.1e (Hassaan Pasha) [#32328](https://github.com/nodejs/node/pull/32328)
* [[`806740a494`](https://github.com/nodejs/node/commit/806740a494)] - **deps**: adjust openssl configuration for 1.1.1e (Hassaan Pasha) [#32328](https://github.com/nodejs/node/pull/32328)
* [[`a1307b0712`](https://github.com/nodejs/node/commit/a1307b0712)] - **deps**: upgrade openssl sources to 1.1.1e (Hassaan Pasha) [#32328](https://github.com/nodejs/node/pull/32328)
* [[`e6d08f91de`](https://github.com/nodejs/node/commit/e6d08f91de)] - **deps**: V8: backport f7771e5b0cc4 (Matheus Marchini) [#31957](https://github.com/nodejs/node/pull/31957)
...
* [[`b2ad98f019`](https://github.com/nodejs/node/commit/b2ad98f019)] - **doc**: link setRawMode() from signal docs (Anna Henningsen) [#32088](https://github.com/nodejs/node/pull/32088)
* [[`b00bd24017`](https://github.com/nodejs/node/commit/b00bd24017)] - **doc**: document self-referencing a package name (Gil Tayar) [#31680](https://github.com/nodejs/node/pull/31680)
* [[`206ba67e4c`](https://github.com/nodejs/node/commit/206ba67e4c)] - **doc**: add AsyncResource + Worker pool example (Anna Henningsen) [#31601](https://github.com/nodejs/node/pull/31601)
* [[`baf99daeea`](https://github.com/nodejs/node/commit/baf99daeea)] - **doc**: document fs.watchFile() bigint option (Colin Ihrig) [#32128](https://github.com/nodejs/node/pull/32128)
* [[`98cf55d77c`](https://github.com/nodejs/node/commit/98cf55d77c)] - **doc**: fix broken links in benchmark README (Rich Trott) [#32121](https://github.com/nodejs/node/pull/32121)
* [[`4254763279`](https://github.com/nodejs/node/commit/4254763279)] - **doc**: update email address in authors (Yael Hermon) [#32026](https://github.com/nodejs/node/pull/32026)
* [[`a8a2c3633c`](https://github.com/nodejs/node/commit/a8a2c3633c)] - **doc**: update maintaining-V8.md (kenzo-spaulding) [#31503](https://github.com/nodejs/node/pull/31503)
* [[`1945680617`](https://github.com/nodejs/node/commit/1945680617)] - **doc**: visibility of Worker threads cli options (Harshitha KP) [#31380](https://github.com/nodejs/node/pull/31380)
* [[`206d0e163d`](https://github.com/nodejs/node/commit/206d0e163d)] - **doc**: improve doc/markdown file organization coherence (ConorDavenport) [#31792](https://github.com/nodejs/node/pull/31792)
...
* [[`65164e5c6d`](https://github.com/nodejs/node/commit/65164e5c6d)] - **events**: fix removeListener for Symbols (zfx) [#31847](https://github.com/nodejs/node/pull/31847)
* [[`81f7a67e32`](https://github.com/nodejs/node/commit/81f7a67e32)] - **fs**: fix valid id range on chown, lchown, fchown (himself65) [#31694](https://github.com/nodejs/node/pull/31694)
...
* [[`4b9fe20fd4`](https://github.com/nodejs/node/commit/4b9fe20fd4)] - **meta**: move thefourtheye to TSC Emeritus (Rich Trott) [#32059](https://github.com/nodejs/node/pull/32059)
...
* [[`833f312969`](https://github.com/nodejs/node/commit/833f312969)] - **src**: use C++ style for struct with initializers (Sam Roberts) [#32134](https://github.com/nodejs/node/pull/32134)
* [[`efcce16979`](https://github.com/nodejs/node/commit/efcce16979)] - **src**: implement per-process native Debug() printer (Joyee Cheung) [#31884](https://github.com/nodejs/node/pull/31884)
* [[`a726a9713f`](https://github.com/nodejs/node/commit/a726a9713f)] - **src**: refactor debug category parsing (Joyee Cheung) [#31884](https://github.com/nodejs/node/pull/31884)
* [[`addc183d68`](https://github.com/nodejs/node/commit/addc183d68)] - **src**: make aliased\_buffer.h self-contained (Joyee Cheung) [#31884](https://github.com/nodejs/node/pull/31884)
* [[`9e836315bd`](https://github.com/nodejs/node/commit/9e836315bd)] - **src**: discard tasks posted to platform TaskRunner during shutdown (Anna Henningsen) [#31853](https://github.com/nodejs/node/pull/31853)
* [[`708dafae4a`](https://github.com/nodejs/node/commit/708dafae4a)] - **src**: Handle bad callback in asyc\_wrap (Harshitha KP) [#31946](https://github.com/nodejs/node/pull/31946)
...
* [[`5d30570d61`](https://github.com/nodejs/node/commit/5d30570d61)] - **test**: always skip vm-timeout-escape-queuemicrotask (Denys Otrishko) [#31980](https://github.com/nodejs/node/pull/31980)
* [[`06d40c59aa`](https://github.com/nodejs/node/commit/06d40c59aa)] - **test**: improve test-debug-usage (Rich Trott) [#32141](https://github.com/nodejs/node/pull/32141)
* [[`e5dc2fbd20`](https://github.com/nodejs/node/commit/e5dc2fbd20)] - **test**: end tls connection with some data (Sam Roberts) [#32328](https://github.com/nodejs/node/pull/32328)
* [[`551b93b3dd`](https://github.com/nodejs/node/commit/551b93b3dd)] - **test**: discard data received by client (Hassaan Pasha) [#32328](https://github.com/nodejs/node/pull/32328)
* [[`14f496d97c`](https://github.com/nodejs/node/commit/14f496d97c)] - **test**: increase test timeout to prevent flakiness (Ruben Bridgewater) [#31716](https://github.com/nodejs/node/pull/31716)
* [[`bd09a7549d`](https://github.com/nodejs/node/commit/bd09a7549d)] - **test**: use index.js if package.json "main" is empty (Ben Noordhuis) [#32040](https://github.com/nodejs/node/pull/32040)
* [[`45a4fd0945`](https://github.com/nodejs/node/commit/45a4fd0945)] - **test**: changed function to arrow function (ProdipRoy89) [#32045](https://github.com/nodejs/node/pull/32045)
* [[`0a3cde571a`](https://github.com/nodejs/node/commit/0a3cde571a)] - **test**: allow EAI\_FAIL in test-net-dns-error.js (Vita Batrla) [#31780](https://github.com/nodejs/node/pull/31780)
* [[`5ea3d14861`](https://github.com/nodejs/node/commit/5ea3d14861)] - **test**: remove superfluous checks in test-net-reconnect-error (Rich Trott) [#32120](https://github.com/nodejs/node/pull/32120)
* [[`59d331bceb`](https://github.com/nodejs/node/commit/59d331bceb)] - **test**: apply camelCase in test-net-reconnect-error (Rich Trott) [#32120](https://github.com/nodejs/node/pull/32120)
* [[`6e98f17a9d`](https://github.com/nodejs/node/commit/6e98f17a9d)] - **test**: update tests for larger Buffers (Jakob Kummerow) [#32114](https://github.com/nodejs/node/pull/32114)
...
* [[`28bd7e3a91`](https://github.com/nodejs/node/commit/28bd7e3a91)] - **tools**: use per-process native Debug() printer in mkcodecache (Joyee Cheung) [#31884](https://github.com/nodejs/node/pull/31884)
